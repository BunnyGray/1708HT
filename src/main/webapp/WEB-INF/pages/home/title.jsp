            ...
            <div style="height:29px;">
                ...
                <div id="mask">
                    <div id="menuContent">
                        ...
                        <span id="topmenu" onclick="toModule('student');">学生登录</span><span id="tm_separator"></span>
                        <%--<span id="topmenu" onclick="toModule('baseinfo');">学生登录.eg</span><span id="tm_separator"></span>--%>
                        <span id="topmenu" onclick="toModule('teacher');">教师登录</span><span id="tm_separator"></span>
                        <span id="topmenu" onclick="toModule('sysadmin');">学位点负责人</span>
                    </div>
