        ...
        <div class="eXtremeTable">
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <tr>
                    ...
                    <td>教职工号：</td>
                    <td><input name="jobNo" value="${teacher.jobNo}"></td>
                    <td>姓名：</td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="teacherType">
                            <option value="校内导师" <c:if
                                    test='${teacher.teacherType=="校内导师"}'> selected="selected" </c:if> >
                                校内导师
                            </option>
                            <option value="企业导师" <c:if
                                    test='${teacher.teacherType=="企业导师"}'> selected="selected" </c:if>>
                                企业导师
                            </option>
                        </select>
                    </td>
