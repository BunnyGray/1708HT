        ...
        <div class="eXtremeTable">
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <tr>
                    ...
                    <td class="tableHeader" style="text-align: center"><input type="file" name="filename" size="45"><br>
                    </td>
                    <td class="tableHeader" style="text-align: center "><input type="submit" name="submit" value="确认上传"
                                                                               style="background: none;color: #00B83F">
                    </td>
                </tr>
                </thead>
            </table>
            <tr>
                <h1>
                    <c:if test='${msg.contains("成功")}'><font color="green">文件"${fname}"上传成功</font> </c:if>
                    <c:if test='${msg.contains("失败")}'><font color="red" >文件"${fname}"上传失败</font> </c:if>
