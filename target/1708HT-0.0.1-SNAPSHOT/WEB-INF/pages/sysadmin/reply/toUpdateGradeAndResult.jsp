    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#" onclick="save()">保存录入</a>
                        </li>
    ...
    <div>
        <div class="eXtremeTable">
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <tr>
                    <td>答辩成绩：</td>
                    <td><input type="text" name="replyGrade" onkeypress="return event.keyCode>=48&&event.keyCode<=57"
                ...
                <tr>
                    <td>答辩最终结果</td>
                    <td><%--<input type="text" name="replyResult"/>--%>

                        <select id="select" name="replyResult">
                            <option>-请录入答辩结果-</option>
...
<script type="text/javascript">
    function getName() {
        ...
        if (Number(inn)) {
            ...
            document.getElementById("in").value = "--请确认姓名对应的学号--";
        }
    }
    ...
    function save() {
        ...
        if (Number(innn)) {
            formSubmit('UpdateGradeAndResult', '_self');
            this.blur();
        } else {
            alert("未选择研究生");
        }
